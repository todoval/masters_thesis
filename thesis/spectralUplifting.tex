...
\begin{figure}[t]
	...
	\caption{Photos of four Munsell Book of Color pages (050B, 075Y, 100Y and 075R) in an xRite Judge QC viewing booth. \textbf{Left:} daylight \textbf{Right:} fluorescent light. The photos are white balanced so that the neutral patches on the color checker match.}
...
We describe the pseudo-algorithm used to create such an uplifting model in~\cref{alg:upliftingAlgSigmoid}.
